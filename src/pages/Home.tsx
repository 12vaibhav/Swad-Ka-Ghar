...
export default function Home() {
  ...
  return (
    <div className="pt-0">
      {/* Hero Section */}
      <section className="min-h-[calc(100vh-80px)] flex flex-col lg:flex-row overflow-hidden border-b border-stone-200 bg-gradient-to-br from-[#fbf9f5] via-[#9b2f00]/[0.06] to-[#2b6954]/[0.08] relative">
        ...
        <div className="contents lg:flex w-full lg:w-[45%] flex-col justify-center relative z-10">
          <div className="order-1 lg:order-none w-full px-6 sm:px-8 md:px-16 lg:px-24 pt-24 lg:pt-0 pb-4 lg:pb-0 relative z-10 flex flex-col items-center lg:items-start text-center lg:text-left">
            <motion.div
            ...
            >
              <div className="w-8 h-[1px] bg-[#984016]/50 hidden lg:block"></div>
              <span className="text-[#984016] font-bold tracking-[0.4em] uppercase text-[10px]">FOUNDED IN MUZAFFARNAGAR</span>
            </motion.div>
            ...
            >
              <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-[5.5rem] xl:text-[6.5rem] font-serif tracking-tighter text-stone-900 leading-[0.9] mb-6 max-w-[14ch] mx-auto lg:mx-0 drop-shadow-sm">
                A Symphony of <span className="text-[#984016]">Spices & Soul.</span>
              </h1>
            </motion.div>
          </div>

          <div className="order-3 lg:order-none w-full px-6 sm:px-8 md:px-16 lg:px-24 pt-4 lg:pt-0 pb-16 lg:pb-0 relative z-10 flex flex-col items-center lg:items-start text-center lg:text-left">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.3, ease: "easeOut" }}
            >
              <p className="font-lora text-lg md:text-xl leading-relaxed text-stone-600 mb-10 italic max-w-lg border-l-0 lg:border-l-2 border-[#984016]/30 pl-0 lg:pl-6 mx-auto lg:mx-0">
            ...
            >
              <Link to="/menu" className="relative overflow-hidden group bg-[#984016] text-white px-8 py-4 rounded-full font-sans font-bold uppercase tracking-widest text-xs transition-all duration-300 shadow-[0_8px_30px_rgb(152,64,22,0.3)] hover:shadow-[0_8px_30px_rgb(152,64,22,0.5)] hover:-translate-y-1">
                <span className="relative z-10">EXPLORE OUR LEGACY</span>
                <div className="absolute inset-0 h-full w-full bg-stone-900 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
              </Link>
              <Link to="/about" className="group flex items-center gap-3 font-sans font-bold uppercase tracking-widest text-xs text-[#984016] hover:text-stone-900 transition-colors px-6 py-3.5 rounded-full border border-[#984016]/30 hover:border-stone-900 bg-transparent">
                <div className="w-8 h-8 rounded-full border border-[#984016]/30 flex items-center justify-center group-hover:border-stone-900 group-hover:bg-stone-900 group-hover:text-white transition-all duration-300">
        ...
        <div className="order-2 lg:order-none w-full lg:w-[55%] px-4 pt-2 pb-8 sm:p-8 lg:p-12 h-auto sm:h-[600px] lg:h-auto min-h-[350px] sm:min-h-[600px] lg:min-h-[calc(100vh-80px)] flex items-center justify-center z-10 relative">
          {/* Decorative background element */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-tr from-[#984016]/15 via-[#984016]/5 to-transparent rounded-full blur-3xl -z-10 animate-pulse" style={{ animationDuration: '4s' }}></div>
          ...
          <div className="relative w-full max-w-[700px] aspect-square">
            ...
            <motion.div 
              ...
              className="absolute left-1/2 sm:left-0 top-[55%] sm:top-1/2 -translate-x-1/2 sm:translate-x-0 -translate-y-1/2 w-[85%] sm:w-[75%] h-[85%] sm:h-[75%] rounded-full shadow-[0_20px_50px_rgba(0,0,0,0.15)] bg-white p-[2px] sm:p-1.5 z-10"
            >
            ...
            <motion.div 
              ...
              className="absolute bottom-[-2%] sm:bottom-[5%] md:bottom-[10%] left-1/2 sm:left-[2%] md:left-[5%] -translate-x-1/2 sm:translate-x-0 z-30 bg-white/95 backdrop-blur-sm rounded-full pl-2 pr-4 py-2 md:pl-3 md:pr-4 md:py-3 flex items-center gap-3 md:gap-4 shadow-[0_10px_40px_rgba(0,0,0,0.12)] w-[220px] sm:w-auto sm:min-w-[240px] border border-white origin-bottom sm:origin-bottom-left"
            >
              <img 
              ...
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[#984016] flex items-center justify-center text-white shadow-lg shadow-[#984016]/40 cursor-pointer hover:scale-110 hover:bg-stone-900 transition-all duration-300">
                <Phone className="w-3.5 h-3.5 sm:w-4 sm:h-4 fill-current" />
              </div>
            </motion.div>

            {/* Small Circles (Row on Mobile, Stack on Desktop) */}
            <div className="absolute top-0 sm:top-1/2 left-1/2 sm:left-auto right-auto sm:right-0 -translate-x-1/2 sm:translate-x-0 sm:-translate-y-1/2 w-[90%] sm:w-auto h-auto sm:h-[85%] flex flex-row sm:flex-col justify-between z-20">
              <motion.div 
                initial={{ opacity: 0, x: 30 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8, delay: 0.4, ease: "easeOut" }}
                className="w-20 h-20 sm:w-28 sm:h-28 md:w-36 md:h-36 rounded-full shadow-[0_10px_30px_rgba(0,0,0,0.1)] bg-white p-[2px] sm:p-1 hover:-translate-y-2 sm:hover:translate-y-0 sm:hover:-translate-x-2 hover:scale-105 transition-all duration-500 cursor-pointer"
              >
                 <img 
      ...
      <section className="pt-8 pb-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-8 md:mt-10 text-center">
            <Link to="/menu" className="inline-block bg-stone-900 text-white px-8 py-3 md:px-12 md:py-5 font-bold uppercase tracking-[0.2em] text-[9px] md:text-[10px] hover:bg-primary transition-colors duration-500 shadow-xl">Explore Full Menu</Link>
          </div>
        </div>
      </section>

      {/* Today's Specials */}
      <section className="pt-8 pb-4 md:py-16 overflow-hidden border-b border-stone-200 bg-[#fcfbf9]">
        ...
        >
          {MENU_ITEMS.filter(item => item.isSpecial).map((item) => (
            <div key={item.id} className="w-[42vw] sm:w-80 md:w-[calc(25%-1.5rem)] shrink-0 md:aspect-square bg-white shadow-sm border border-stone-200 group hover:shadow-xl transition-shadow duration-500 snap-center flex flex-col">
              ...
              <div className="p-3 sm:p-5 md:p-6 flex flex-col flex-grow">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pt-2 sm:pt-3 md:pt-4 border-t border-stone-100 mt-auto gap-2 sm:gap-0">
                  ...
                  <button className="w-full sm:w-auto bg-stone-900 text-white px-2 py-1.5 sm:px-4 sm:py-2 md:px-5 md:py-2.5 text-[8px] md:text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-primary transition-colors duration-500">Add</button>
                </div>
              </div>
            </div>
          ))}
      ...
      {/* Chef Profile */}
      <section className="py-12 md:py-16 bg-stone-900 text-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-8 md:gap-24">
          <div className="w-full md:w-1/2 relative px-4 md:px-0">
            ...
            <img 
              alt="Master Chef Ranveer Sharma" 
              className="w-full aspect-square md:aspect-[4/5] object-cover transition-all duration-1000" 
              ...
              referrerPolicy="no-referrer"
            />
            <div className="absolute -bottom-4 -right-2 md:-bottom-8 md:-right-8 bg-primary p-4 md:p-8 text-center">
              <p className="text-2xl md:text-4xl font-serif italic">30+</p>
              <p className="text-[8px] md:text-[10px] uppercase tracking-widest font-bold">Years of Mastery</p>
            </div>
          </div>
          <div className="w-full md:w-1/2 mt-4 md:mt-0">
            ...
            <p className="font-lora text-sm md:text-xl text-stone-400 italic mb-6 md:mb-8 leading-relaxed border-l-2 border-primary/30 pl-4 md:pl-6">
            ...
            <div className="space-y-4 md:space-y-6 mb-8 md:mb-12">
              ...
              <div className="flex flex-wrap gap-2 md:gap-4 pt-2 md:pt-4">
                {['Nawabi Gosht', 'Shahi Tukda', 'Dal-e-Khaas'].map(tag => (
                  <span key={tag} className="border border-white/20 px-3 py-1.5 md:px-4 md:py-2 text-[8px] md:text-[10px] uppercase tracking-[0.2em] font-bold text-stone-300">{tag}</span>
                ))}
              </div>
            </div>
      ...
      <section className="py-8 md:py-16 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex md:grid md:grid-cols-3 gap-4 md:gap-8 lg:gap-12 -mx-6 px-6 md:mx-0 md:px-0 overflow-x-auto md:overflow-visible snap-x snap-mandatory md:snap-none pb-6 md:pb-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            {TESTIMONIALS.map((t, i) => (
              <div key={t.id} className={cn(
                "flex-none w-[75vw] sm:w-80 md:w-auto snap-center md:snap-align-none bg-[#fcfbf9] p-5 sm:p-8 md:p-10 lg:p-12 relative border border-stone-200 transition-all duration-500",
                i === 1 ? "md:-translate-y-4 shadow-xl z-10 bg-white" : "hover:shadow-md"
              )}>
              <div className="flex gap-1 text-primary mb-4 md:mb-8">
                {[...Array(5)].map((_, j) => <Star key={j} size={12} className="md:w-3.5 md:h-3.5" fill="currentColor" />)}
              </div>
              <p className="font-lora text-sm md:text-lg text-stone-700 italic mb-6 md:mb-10 leading-relaxed">"{t.content}"</p>
              <div className="flex items-center gap-3 md:gap-4 pt-4 md:pt-6 border-t border-stone-200">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full overflow-hidden border border-stone-200 shrink-0">
                  <img alt={t.name} className="w-full h-full object-cover" src={t.avatar} referrerPolicy="no-referrer" />
                </div>
                <div>
                  <h5 className="font-bold text-[9px] md:text-[10px] uppercase tracking-[0.2em] text-stone-900">{t.name}</h5>
                  <p className="text-[8px] md:text-[10px] text-stone-500 uppercase tracking-wider mt-0.5 md:mt-1">{t.role}</p>
                </div>
              </div>
            </div>
          ))}
      ...
      <section className="py-10 md:py-16 bg-[#f5f2ed] text-stone-900 relative overflow-hidden">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="hidden sm:grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-10">
                <div className="relative pl-8 border-l border-stone-300">
                  <span className="absolute -left-3 top-0 text-[10px] font-bold text-primary bg-[#f5f2ed] px-1">01</span>
                ...
                <div className="relative pl-8 border-l border-stone-300">
                  <span className="absolute -left-3 top-0 text-[10px] font-bold text-primary bg-[#f5f2ed] px-1">02</span>
              ...
              <div className="mt-6 md:hidden">
                <Link to="/reservations" className="group relative block w-full bg-stone-900 text-white py-4 overflow-hidden text-center shadow-xl">
              ...
              <div className="bg-white p-6 md:p-12 lg:p-16 shadow-[0_30px_100px_rgba(0,0,0,0.08)] border border-stone-100 relative mt-4 lg:mt-0">
                ...
                <div className="space-y-6 md:space-y-8">
                  ...
                  <div className="pt-2 md:pt-4">
                    <Link to="/reservations" className="group relative block w-full bg-stone-900 text-white py-4 md:py-6 overflow-hidden text-center">
